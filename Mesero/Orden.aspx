<%@ Page Language="C#" MasterPageFile="MainMesero.master" AutoEventWireup="true" Src="Orden.aspx.cs"
    Inherits="MenusController" Title="Orden" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="Menu">
        ...
        <div class="menu-containerMenus">
            ...
            <div class="buttons">
                    <asp:Button runat="server" ID="btnAdd" Text="Agregar a la orden" OnClick="btnAgregarMenu_Click" CssClass="btnAddOrder" />
            ...
            <div class="inputs">
                ...
                <asp:TextBox runat="server" ID="txtTotal" ReadOnly="true" CssClass="txtPay"/>
